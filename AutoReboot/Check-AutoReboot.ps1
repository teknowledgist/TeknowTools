...
.PARAMETER GracePeriod
   The number of hours after a boot during which pending reboot warnings
   will be suppressed.  This prevents users who regularly reboot
   from being bothered by too many notifications.
   Default Value:  24
.PARAMETER Purl
...
Param(
   ...
   # Number of hours after a reboot when warnings are suppressed.
   [int]$GracePeriod = 24,
